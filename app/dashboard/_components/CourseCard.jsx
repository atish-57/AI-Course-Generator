    ...
    <div className="shadow-sm rounded-md border  cursor-pointer hover:border-primary">
      <Link href={"/course/" + course?.courseId}>
        <Image
          ...
          alt={course?.courseOutput?.course?.name ? `${course.courseOutput.course.name} banner` : "Course banner"}
        />
      </Link>
      <div className="p-2">
        ...
        {displayUser && (
          <div className="flex items-center gap-2 mt-2">
            <Image
              ...
              alt={course?.userName ? `${course.userName} profile` : "User profile image"}
            />
